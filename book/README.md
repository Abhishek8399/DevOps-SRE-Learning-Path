...
The canonical reader at checkpoint `f3b9f1b` exposes twenty-six lessons across Volumes 00 through 04: four established typed bodies plus twenty-two schema-backed `substantive-draft` lessons. `LES-0002` is the first exact-identity legacy migration. The structured corpus contains 66 assessments—forty-four complete-answer records and twenty-two answer-isolated independent transfers—and 175 references. Its content, registry, schema, reader, lint, typecheck, build, static lab, loopback-HTTP, budget, hygiene, commit, and push gates pass. The LES-0002 Ubuntu verifier and real-browser interaction remain unavailable and unclaimed. Resolved prerequisite IDs remain advisory: they never lock a route, mark work complete, or award mastery.
