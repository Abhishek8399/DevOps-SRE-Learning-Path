...
All five published legacy bodies, `LES-0001` through `LES-0005`, are migrated into the schema contract; `LES-0006` was the first newly authored schema-backed lesson. The canonical corpus contains forty-one structured `substantive-draft` lessons, 123 assessments—eighty-two complete-answer records and forty-one answer-isolated independent transfers—and 414 references. No typed body remains in the reader. `LES-0042` through `LES-0092` and support IDs `ASM-0109` through `ASM-0261` plus `REF-0388` through `REF-1199` belong to staged authored packages; do not reuse them. The next free support IDs are `ASM-0277` and `REF-1227`. `LES-0004` alone preserves its frozen Volume-01/order-04 home while owning `NET-003`; the validator permits this only when its complete permanent legacy identity matches, and rejects any drift or new cross-volume claim. A published legacy identity remains in the permanent map after migration. An ID is permanent once published and is never recycled. Schema validity and publication do not constitute formal chapter acceptance, provider execution, or learner mastery.
