...
The lab is at:
    ...
    book/labs/LES-0056-sql-postgresql-internals-reliability
...
### Step 1: inspect and diagnose readiness
    ...
    cd book/labs/LES-0056-sql-postgresql-internals-reliability
    sed -n '1,260p' lab.sh
