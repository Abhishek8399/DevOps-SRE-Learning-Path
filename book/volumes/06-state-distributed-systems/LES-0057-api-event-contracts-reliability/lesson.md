...
From Ubuntu 24.04 as a normal user:
    ...
    cd book/labs/LES-0057-api-event-contracts-reliability
    bash lab.sh doctor
    bash lab.sh setup
    bash lab.sh status
