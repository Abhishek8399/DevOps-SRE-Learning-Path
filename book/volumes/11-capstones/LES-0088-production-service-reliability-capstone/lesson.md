...
Run commands from `book/labs/LES-0088-production-service-reliability-capstone` inside Ubuntu. Read `README.md` first. Never paste an incident command before naming its question.
...
```bash
cd /path/to/DevOps-SRE-Learning-Path/book/labs/LES-0088-production-service-reliability-capstone
pwd
id
git rev-parse HEAD
python3 --version
