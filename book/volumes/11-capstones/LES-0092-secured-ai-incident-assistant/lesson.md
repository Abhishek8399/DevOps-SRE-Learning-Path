...
Run every command from `book/labs/LES-0092-secured-ai-incident-assistant-capstone` as a normal user. Do not use `sudo`. The project needs only Python 3.12-compatible standard-library behavior and contacts no network service.
...
cd "$repo_root/book/labs/LES-0092-secured-ai-incident-assistant-capstone"
pwd
```
