...
```bash
cd /path/to/DevOps-SRE-Learning-Path/book/labs/LES-0089-kubernetes-platform-engineering-capstone
```
...
python3 ops/reconcile.py \
  --source book/labs/LES-0089-kubernetes-platform-engineering-capstone/desired/team-a/payments-api.yaml \
  --revision HEAD
```
