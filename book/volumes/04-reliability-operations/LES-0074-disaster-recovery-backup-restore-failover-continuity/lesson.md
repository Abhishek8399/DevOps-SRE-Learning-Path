...
```bash
cd /home/your-user/work/DevOps-SRE-Learning-Path/book/labs/LES-0074-disaster-recovery-backup-restore-failover-continuity
pwd
bash lab.sh doctor
bash lab.sh setup
bash lab.sh status
