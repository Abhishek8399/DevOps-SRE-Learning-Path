...
- **AWS/EKS and cloud reliability:** EC2, ASG, VPC, IAM, ECR, EKS/ECS, RDS, S3, Lambda, CloudWatch, cost, backup, and disaster recovery. Local labs will model behavior without creating cloud resources.
- **Private cloud and compute:** KVM, libvirt, OpenStack, bare metal, Ceph, OVS/OVN, high availability, and lifecycle operations.
- **Data and ML platforms:** Spark, Flink, Trino/Pinot, Iceberg, Airflow, MLflow, catalogs, notebooks, vector databases, and Cassandra.
