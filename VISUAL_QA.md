...
| 2026-09-07 | Browser runtime unavailable; HTTP viewport-independent | All 92 canonical lessons plus twenty primary application surfaces | Pass for HTTP: 112/112 expected routes return 200, invalid lesson returns 404, zero transform-error markers. Browser runtime discovery and the required troubleshooting inventory return no available backend | None | Preserve visual, responsive, theme, focus, keyboard, clipboard, persistence, zoom, screen-reader and print work as unverified |
| 2026-09-07 | Source/build evidence only; browser unavailable | Mobile navigation and context overlays | Source, type, lint, reader-test and build pass: one overlay at a time below 980 px, persistent close actions, trigger-focus return and background-scroll locks are implemented | None | Run the phone/tablet keyboard, zoom and screen-reader matrix before acceptance; no rendered behavior is claimed |
| 2026-09-08 | Browser unavailable; HTTP viewport-independent | Full canonical and career reading surface | Follow-up pass after correcting the generated-primer filename and fence metadata: 202/202 expected routes return 200, including the new portfolio defense chapter; invalid lesson returns 404; zero transform-error markers | None | Career-card hierarchy, long-form table/code layout, themes, keyboard, focus, zoom, screen reader and print remain visually unverified |
| 2026-09-08 | Browser unavailable; HTTP viewport-independent | Product-company readiness chapter and full reading surface | 203/203 expected routes return 200 after the rebuilt server refresh, including 92 lessons and 91 career primers; invalid lesson returns 404; zero transform-error markers | None | New rubric/table readability, responsive flow, themes, keyboard, focus, zoom, screen reader and print remain visually unverified |
