...
`ASM-0259` diagnoses an assistant security/control incident spanning unsupported claims, cross-tenant retrieval, injection, sensitive data, release drift, excessive tool authority, reusable approval, ambiguous retry, deficient audit and coupled kill. `ASM-0260` replaces an unsafe enterprise design with evidence, authority, evaluation, privacy, reliability and staged-delivery contracts. `ASM-0261` reserves reviewer-owned transfer with a materially changed domain and at least five hidden faults. Direct schemas pass; rubrics total 50/100/100 and the independent record contains no answer-derived fields.
