...
Fifteen official OpenStack sources are locked across the current security guide and latest Keystone, Nova, Placement, Neutron, Glance and Cinder documentation. Every exact URL resolved on 2026-08-07. Because `latest` documentation can represent a development branch, the lesson must keep release identity and compatibility as explicit operational evidence rather than treating these pages as proof of a deployed version.
