...
const liveLessonDescriptors = [
  ...
  {
    id: "LES-0049",
    path: join(repositoryRoot, "book", "volumes", "03-engineering-delivery", "LES-0049-gitops-reconciliation-promotion", "lesson.md"),
    expected: { aliases: ["V05-L13", "gitops-reconciliation-promotion"], curriculumIds: ["GITOPS-001"], prerequisiteCurriculumIds: ["SCM-001", "CI-001", "IAC-001", "K8S-001", "K8S-006", "K8S-008"], prerequisiteLessonIds: ["LES-0009", "LES-0024", "LES-0037", "LES-0041", "LES-0046", "LES-0048"], order: 13, route: "/book/engineering/gitops-reconciliation-promotion", slug: "gitops-reconciliation-promotion", volume: "03-engineering-delivery" },
  },
  {
    id: "LES-0026",
    path: join(
  ...
  },
  {
    ...
    path: join(
      ...
      "volumes",
      "04-reliability-operations",
      "LES-0027-opentelemetry-instrumentation-pipelines",
      "lesson.md",
    ),
    expected: {
  ...
  {
    id: "LES-0028", path: join(repositoryRoot, "book", "volumes", "04-reliability-operations", "LES-0028-prometheus-promql-grafana", "lesson.md"),
    expected: { aliases: ["V04-L03", "prometheus-promql-grafana"], curriculumIds: ["OBS-003"], prerequisiteCurriculumIds: ["OBS-001", "DBG-001"], prerequisiteLessonIds: ["LES-0026", "LES-0008"], order: 3, route: "/book/reliability/prometheus-promql-grafana", slug: "prometheus-promql-grafana", volume: "04-reliability-operations" },
  },
  {
    id: "LES-0029", path: join(repositoryRoot, "book", "volumes", "04-reliability-operations", "LES-0029-structured-logging-pipelines", "lesson.md"),
    expected: { aliases: ["V04-L04", "structured-logging-pipelines"], curriculumIds: ["OBS-004"], prerequisiteCurriculumIds: ["OBS-001", "DBG-001", "AUT-005"], prerequisiteLessonIds: ["LES-0026", "LES-0008", "LES-0021"], order: 4, route: "/book/reliability/structured-logging-pipelines", slug: "structured-logging-pipelines", volume: "04-reliability-operations" },
  },
  {
    id: "LES-0030", path: join(repositoryRoot, "book", "volumes", "04-reliability-operations", "LES-0030-alerting-dashboards-user-journeys", "lesson.md"),
    expected: { aliases: ["V04-L05", "alerting-dashboards-user-journeys"], curriculumIds: ["OBS-005"], prerequisiteCurriculumIds: ["OBS-001", "SRE-002"], prerequisiteLessonIds: ["LES-0026", "LES-0008"], order: 5, route: "/book/reliability/alerting-dashboards-user-journeys", slug: "alerting-dashboards-user-journeys", volume: "04-reliability-operations" },
  },
  {
  ...
  ...[
    ["LES-0037", "infrastructure-as-code-foundations", "V05-L01", "IAC-001", 1, ["LES-0009", "LES-0021", "LES-0024"], ["SCM-001", "AUT-005", "CI-001"]],
    ["LES-0038", "terraform-opentofu-language-plan", "V05-L02", "TFM-001", 2, ["LES-0037"], ["IAC-001"]],
    ["LES-0039", "terraform-opentofu-modules-state-recovery", "V05-L03", "TFM-002", 3, ["LES-0038"], ["TFM-001"]],
    ["LES-0040", "ansible-configuration-management", "V05-L04", "CFG-001", 4, ["LES-0009", "LES-0011", "LES-0017", "LES-0039"], ["LNX-004", "AUT-001", "SCM-001", "TFM-002"]],
    ["LES-0041", "kubernetes-control-plane-reconciliation", "V05-L05", "K8S-001", 5, ["LES-0004", "LES-0009", "LES-0023"], ["NET-003", "SCM-001", "CTR-001"]],
    ["LES-0042", "kubernetes-workloads-scheduling-rollouts", "V05-L06", "K8S-002", 6, ["LES-0012", "LES-0023", "LES-0041"], ["LNX-003", "CTR-001", "K8S-001"]],
    ["LES-0043", "kubernetes-networking-services-dns-policy", "V05-L07", "K8S-003", 7, ["LES-0004", "LES-0013", "LES-0014", "LES-0015", "LES-0016", "LES-0041", "LES-0042"], ["NET-003", "NET-004", "NET-005", "NET-006", "K8S-001", "K8S-002"]],
    ["LES-0044", "kubernetes-storage-persistence-recovery", "V05-L08", "K8S-004", 8, ["LES-0006", "LES-0011", "LES-0023", "LES-0041", "LES-0042"], ["LNX-001", "LNX-006", "CTR-001", "K8S-001", "K8S-002"]],
    ["LES-0045", "kubernetes-identity-rbac-admission-tenancy", "V05-L09", "K8S-005", 9, ["LES-0011", "LES-0016", "LES-0041", "LES-0042", "LES-0043"], ["LNX-004", "NET-006", "K8S-001", "K8S-002", "K8S-003"]],
    ["LES-0046", "helm-kustomize-packaging-releases", "V05-L10", "K8S-006", 10, ["LES-0009", "LES-0024", "LES-0041", "LES-0042", "LES-0045"], ["SCM-001", "CI-001", "K8S-001", "K8S-002", "K8S-005"]],
    ["LES-0047", "kubernetes-operators-custom-resources-admission", "V05-L11", "K8S-007", 11, ["LES-0020", "LES-0021", "LES-0041", "LES-0045", "LES-0046"], ["AUT-004", "AUT-005", "K8S-001", "K8S-005", "K8S-006"]],
    ["LES-0048", "kubernetes-production-operations", "V05-L12", "K8S-008", 12, ["LES-0032", "LES-0035", "LES-0041", "LES-0042", "LES-0043", "LES-0044", "LES-0045", "LES-0046", "LES-0047"], ["SRE-002", "PERF-001", "K8S-001", "K8S-002", "K8S-003", "K8S-004", "K8S-005", "K8S-006", "K8S-007"]],
    ["LES-0050", "cloud-architecture-provider-neutral-foundations", "V05-L14", "CLD-001", 14, ["LES-0007", "LES-0010", "LES-0015", "LES-0037", "LES-0035"], ["FND-001", "NET-002", "NET-007", "IAC-001", "PERF-001"]],
    ["LES-0051", "identity-secrets-certificates-zero-trust", "V05-L15", "IAM-001", 15, ["LES-0012", "LES-0015", "LES-0045", "LES-0050"], ["LNX-004", "NET-006", "K8S-005", "CLD-001"]],
    ["LES-0052", "cloud-networking-hybrid-connectivity", "V05-L16", "CLD-002", 16, ["LES-0009", "LES-0010", "LES-0011", "LES-0013", "LES-0014", "LES-0015", "LES-0016", "LES-0050", "LES-0051"], ["NET-001", "NET-002", "NET-003", "NET-004", "NET-005", "NET-006", "NET-007", "CLD-001", "IAM-001"]],
    ["LES-0053", "aws-foundations-reliability", "V05-L17", "AWS-001", 17, ["LES-0035", "LES-0036", "LES-0050", "LES-0051", "LES-0052"], ["TFM-001", "CLD-001", "IAM-001", "CLD-002"]],
    ["LES-0054", "azure-foundations-reliability", "V05-L18", "AZR-001", 18, ["LES-0035", "LES-0036", "LES-0050", "LES-0051", "LES-0052"], ["TFM-001", "CLD-001", "IAM-001", "CLD-002"]],
    ["LES-0055", "gcp-foundations-reliability", "V05-L19", "GCP-001", 19, ["LES-0035", "LES-0036", "LES-0050", "LES-0051", "LES-0052"], ["TFM-001", "CLD-001", "IAM-001", "CLD-002"]],
  ].map(([id, slug, alias, curriculumId, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", "05-infrastructure-platforms", `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/infrastructure/${slug}`, slug, volume: "05-infrastructure-platforms" },
  })),
  {
    id: "LES-0056",
    ...
    expected: { aliases: ["V06-L01", "sql-postgresql-internals-reliability"], curriculumIds: ["DST-002"], prerequisiteCurriculumIds: ["LNX-006", "AUT-005"], prerequisiteLessonIds: ["LES-0010", "LES-0021"], order: 1, route: "/book/state/sql-postgresql-internals-reliability", slug: "sql-postgresql-internals-reliability", volume: "06-state-distributed-systems" },
  },
  ...[
    ["LES-0057", "api-event-contracts-reliability", "V06-L02", "DST-001", 2, ["LES-0015", "LES-0021"], ["AUT-005", "NET-005"]],
    ["LES-0058", "distributed-systems-foundations", "V06-L03", "DST-005", 3, ["LES-0007", "LES-0012", "LES-0056"], ["FND-001", "NET-003", "DST-002"]],
    ["LES-0059", "nosql-cache-reliability", "V06-L04", "DST-003", 4, ["LES-0015", "LES-0056", "LES-0058"], ["NET-005", "DST-002", "DST-005"]],
    ["LES-0060", "queues-streams-reliability", "V06-L05", "DST-004", 5, ["LES-0057", "LES-0058", "LES-0059"], ["DST-001", "DST-005"]],
    ["LES-0061", "distributed-workflows-reliability", "V06-L06", "DST-006", 6, ["LES-0057", "LES-0058", "LES-0060"], ["DST-001", "DST-002", "DST-004", "RES-001"]],
  ].map(([id, slug, alias, curriculumId, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", "06-state-distributed-systems", `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/state/${slug}`, slug, volume: "06-state-distributed-systems" },
  })),
  ...[
    ["LES-0062", "data-pipeline-reliability", "V06-L07", "DMP-001", 7, ["LES-0026", "LES-0060", "LES-0061"], ["DST-004", "PERF-001", "K8S-002"]],
    ["LES-0063", "lakehouse-table-reliability", "V06-L08", "DMP-002", 8, ["LES-0056", "LES-0058", "LES-0062"], ["DST-002", "DST-005", "LNX-006"]],
    ["LES-0064", "workflow-ml-platform-reliability", "V06-L09", "DMP-003", 9, ["LES-0026", "LES-0061", "LES-0062"], ["OBS-001", "DST-006", "DMP-001"]],
    ["LES-0065", "specialized-data-service-reliability", "V06-L10", "DMP-004", 10, ["LES-0058", "LES-0059", "LES-0063"], ["DST-005", "DST-003", "DMP-002"]],
  ].map(([id, slug, alias, curriculumId, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", "06-state-distributed-systems", `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/state/${slug}`, slug, volume: "06-state-distributed-systems" },
  ...
  ].map(([id, slug, alias, curriculumId, routeDomain, volume, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", volume, `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/${routeDomain}/${slug}`, slug, volume },
  })),
  ...[
    ["LES-0077", "openstack-control-data-plane-operations", "V09-L02", "PRV-002", "privatecloud", "09-private-cloud", 2, ["LES-0012", "LES-0051", "LES-0058", "LES-0076"], ["NET-002", "IAM-001", "DST-005", "PRV-001"]],
    ["LES-0078", "ceph-storage-reliability-operations", "V09-L03", "PRV-003", "privatecloud", "09-private-cloud", 3, ["LES-0010", "LES-0058", "LES-0074", "LES-0077"], ["LNX-006", "NET-007", "DST-005", "PRV-002"]],
    ["LES-0079", "ovs-ovn-virtual-networking", "V09-L04", "PRV-004", "privatecloud", "09-private-cloud", 4, ["LES-0012", "LES-0013", "LES-0014", "LES-0015", "LES-0016", "LES-0052", "LES-0077"], ["NET-001", "NET-002", "NET-003", "NET-004", "NET-005", "NET-006", "NET-007", "PRV-002"]],
    ["LES-0080", "bare-metal-fleet-lifecycle", "V09-L05", "PRV-005", "privatecloud", "09-private-cloud", 5, ["LES-0006", "LES-0007", "LES-0008", "LES-0010", "LES-0012", "LES-0016", "LES-0072", "LES-0073", "LES-0074", "LES-0076", "LES-0077"], ["LNX-001", "LNX-005", "LNX-006", "LNX-008", "NET-001", "NET-002", "NET-006", "IAC-001", "CFG-001", "SEC-001", "PRV-001"]],
    ["LES-0081", "finops-cost-engineering", "V05-L20", "FIN-001", "infrastructure", "05-infrastructure-platforms", 20, ["LES-0026", "LES-0035", "LES-0050"], ["OBS-001", "PERF-001", "CLD-001"]],
  ].map(([id, slug, alias, curriculumId, routeDomain, volume, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", volume, `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/${routeDomain}/${slug}`, slug, volume },
  ...
  ...[
    ["LES-0082", "architecture-system-design-foundations", "V10-L01", "ARC-001", "architecture", "10-architecture-leadership", 1, ["LES-0007", "LES-0008"], ["FND-001", "DBG-001", "DOC-001"]],
    ["LES-0083", "architecture-strategy-migration-governance", "V10-L02", "ARC-002", "architecture", "10-architecture-leadership", 2, ["LES-0082", "LES-0035", "LES-0081"], ["ARC-001", "PERF-001", "FIN-001"]],
    ["LES-0084", "technical-writing-operational-documents", "V00-L03", "DOC-001", "start", "00-start-safely", 3, ["LES-0007"], ["FND-001"]],
    ["LES-0085", "technical-leadership-engineering-organizations", "V10-L03", "LDR-001", "architecture", "10-architecture-leadership", 3, ["LES-0084", "LES-0033"], ["DOC-001", "SRE-003"]],
    ["LES-0086", "behavioral-leadership-incident-project-interviews", "V10-L04", "INT-002", "architecture", "10-architecture-leadership", 4, ["LES-0085"], ["LDR-001"]],
    ["LES-0087", "devops-sre-platform-career-roadmaps", "V10-L05", "CAR-001", "architecture", "10-architecture-leadership", 5, ["LES-0086"], ["INT-002"]],
    ["LES-0088", "production-service-reliability-capstone", "V11-L01", "CAP-001", "capstones", "11-capstones", 1, ["LES-0087"], ["LNX-001", "NET-005", "AUT-002", "BLD-001", "CI-001", "CTR-002", "OBS-001", "SRE-001", "DR-001", "SEC-001", "REL-001"]],
    ["LES-0089", "kubernetes-platform-engineering-capstone", "V11-L02", "CAP-002", "capstones", "11-capstones", 2, ["LES-0088"], ["IAC-001", "K8S-001", "K8S-002", "K8S-003", "K8S-004", "K8S-005", "K8S-006", "K8S-007", "K8S-008", "GITOPS-001", "PLT-001", "PLT-002", "PLT-003", "PLT-004", "SRE-001", "SEC-002"]],
    ["LES-0090", "distributed-data-reliability-capstone", "V11-L03", "CAP-003", "capstones", "11-capstones", 3, ["LES-0089"], ["AUT-002", "DST-002", "DST-004", "DST-006", "DMP-001", "DMP-002", "OBS-001", "SRE-002", "DR-001"]],
    ["LES-0091", "private-cloud-reliability-capstone", "V11-L04", "CAP-004", "capstones", "11-capstones", 4, ["LES-0090"], ["PRV-001", "PRV-002", "PRV-003", "PRV-004", "PRV-005", "SRE-002", "DR-001", "SEC-001", "ARC-001"]],
    ["LES-0092", "secured-ai-incident-assistant", "V11-L05", "CAP-005", "capstones", "11-capstones", 5, ["LES-0091"], ["AUT-002", "OBS-001", "SRE-003", "SEC-001", "AIO-001", "AIO-002", "AIO-003", "AIO-004"]],
  ].map(([id, slug, alias, curriculumId, routeDomain, volume, order, prerequisiteLessonIds, prerequisiteCurriculumIds]) => ({
    id,
    path: join(repositoryRoot, "book", "volumes", volume, `${id}-${slug}`, "lesson.md"),
    expected: { aliases: [alias, slug], curriculumIds: [curriculumId], prerequisiteCurriculumIds, prerequisiteLessonIds, order, route: `/book/${routeDomain}/${slug}`, slug, volume },
...
test("ninety-two live structured lessons preserve exact identities and canonical sections", () => {
  const bundles = loadLiveStructuredBundles();
  assert.equal(bundles.length, 92);
  assert.deepEqual(
    bundles.map(({ lesson }) => lesson.metadata.id),
    ["LES-0001", "LES-0002", "LES-0003", "LES-0005", "LES-0004", "LES-0007", "LES-0008", "LES-0009", "LES-0006", ...Array.from({ length: 16 }, (_, index) => `LES-${String(index + 10).padStart(4, "0")}`), "LES-0049", ...Array.from({ length: 23 }, (_, index) => `LES-${String(index + 26).padStart(4, "0")}`), ...Array.from({ length: 20 }, (_, index) => `LES-${String(index + 50).padStart(4, "0")}`), "LES-0071", "LES-0070", ...Array.from({ length: 21 }, (_, index) => `LES-${String(index + 72).padStart(4, "0")}`)],
  );
...
test("the volume-aware reader catalog publishes ninety-two stable identities across twelve volumes", () => {
  ...
  assert.deepEqual(getReaderVolume("06-state-distributed-systems"), {
  ...
  const legacyEntries = legacyMap.lessons
    .filter((lesson) => !["LES-0001", "LES-0002", "LES-0003", "LES-0004", "LES-0005"].includes(lesson.id))
    .map((lesson) => ({
  ...
  assert.deepEqual(
    ...
    [
      ...
      ["LES-0084", "LES-0084", "/book/start/technical-writing-operational-documents", "00-start-safely", 3],
      ...
      ["LES-0073", "LES-0073", "/book/linux/linux-performance-analysis-safe-tuning", "01-linux-systems", 9],
      ...
      ["LES-0049", "LES-0049", "/book/engineering/gitops-reconciliation-promotion", "03-engineering-delivery", 13],
      ["LES-0026", "LES-0026", "/book/reliability/observability-foundations", "04-reliability-operations", 1],
      ["LES-0027", "LES-0027", "/book/reliability/opentelemetry-instrumentation-pipelines", "04-reliability-operations", 2],
      ["LES-0028", "LES-0028", "/book/reliability/prometheus-promql-grafana", "04-reliability-operations", 3],
      ...
      ["LES-0074", "LES-0074", "/book/reliability/disaster-recovery-backup-restore-failover-continuity", "04-reliability-operations", 12],
      ["LES-0075", "LES-0075", "/book/reliability/chaos-engineering-safe-experiments-game-days", "04-reliability-operations", 13],
      ["LES-0037", "LES-0037", "/book/infrastructure/infrastructure-as-code-foundations", "05-infrastructure-platforms", 1],
      ["LES-0038", "LES-0038", "/book/infrastructure/terraform-opentofu-language-plan", "05-infrastructure-platforms", 2],
      ["LES-0039", "LES-0039", "/book/infrastructure/terraform-opentofu-modules-state-recovery", "05-infrastructure-platforms", 3],
      ["LES-0040", "LES-0040", "/book/infrastructure/ansible-configuration-management", "05-infrastructure-platforms", 4],
      ["LES-0041", "LES-0041", "/book/infrastructure/kubernetes-control-plane-reconciliation", "05-infrastructure-platforms", 5],
      ["LES-0042", "LES-0042", "/book/infrastructure/kubernetes-workloads-scheduling-rollouts", "05-infrastructure-platforms", 6],
      ["LES-0043", "LES-0043", "/book/infrastructure/kubernetes-networking-services-dns-policy", "05-infrastructure-platforms", 7],
      ["LES-0044", "LES-0044", "/book/infrastructure/kubernetes-storage-persistence-recovery", "05-infrastructure-platforms", 8],
      ["LES-0045", "LES-0045", "/book/infrastructure/kubernetes-identity-rbac-admission-tenancy", "05-infrastructure-platforms", 9],
      ["LES-0046", "LES-0046", "/book/infrastructure/helm-kustomize-packaging-releases", "05-infrastructure-platforms", 10],
      ["LES-0047", "LES-0047", "/book/infrastructure/kubernetes-operators-custom-resources-admission", "05-infrastructure-platforms", 11],
      ["LES-0048", "LES-0048", "/book/infrastructure/kubernetes-production-operations", "05-infrastructure-platforms", 12],
      ["LES-0050", "LES-0050", "/book/infrastructure/cloud-architecture-provider-neutral-foundations", "05-infrastructure-platforms", 14],
      ["LES-0051", "LES-0051", "/book/infrastructure/identity-secrets-certificates-zero-trust", "05-infrastructure-platforms", 15],
      ["LES-0052", "LES-0052", "/book/infrastructure/cloud-networking-hybrid-connectivity", "05-infrastructure-platforms", 16],
      ["LES-0053", "LES-0053", "/book/infrastructure/aws-foundations-reliability", "05-infrastructure-platforms", 17],
      ["LES-0054", "LES-0054", "/book/infrastructure/azure-foundations-reliability", "05-infrastructure-platforms", 18],
      ["LES-0055", "LES-0055", "/book/infrastructure/gcp-foundations-reliability", "05-infrastructure-platforms", 19],
      ["LES-0081", "LES-0081", "/book/infrastructure/finops-cost-engineering", "05-infrastructure-platforms", 20],
      ["LES-0056", "LES-0056", "/book/state/sql-postgresql-internals-reliability", "06-state-distributed-systems", 1],
      ["LES-0057", "LES-0057", "/book/state/api-event-contracts-reliability", "06-state-distributed-systems", 2],
      ["LES-0058", "LES-0058", "/book/state/distributed-systems-foundations", "06-state-distributed-systems", 3],
      ["LES-0059", "LES-0059", "/book/state/nosql-cache-reliability", "06-state-distributed-systems", 4],
      ["LES-0060", "LES-0060", "/book/state/queues-streams-reliability", "06-state-distributed-systems", 5],
      ["LES-0061", "LES-0061", "/book/state/distributed-workflows-reliability", "06-state-distributed-systems", 6],
      ["LES-0062", "LES-0062", "/book/state/data-pipeline-reliability", "06-state-distributed-systems", 7],
      ["LES-0063", "LES-0063", "/book/state/lakehouse-table-reliability", "06-state-distributed-systems", 8],
      ...
      ["LES-0072", "LES-0072", "/book/security/runtime-platform-hardening-vulnerability-compliance", "08-security-engineering", 3],
      ["LES-0076", "LES-0076", "/book/privatecloud/virtualization-kvm-libvirt-foundations", "09-private-cloud", 1],
      ["LES-0077", "LES-0077", "/book/privatecloud/openstack-control-data-plane-operations", "09-private-cloud", 2],
      ["LES-0078", "LES-0078", "/book/privatecloud/ceph-storage-reliability-operations", "09-private-cloud", 3],
      ["LES-0079", "LES-0079", "/book/privatecloud/ovs-ovn-virtual-networking", "09-private-cloud", 4],
      ["LES-0080", "LES-0080", "/book/privatecloud/bare-metal-fleet-lifecycle", "09-private-cloud", 5],
      ["LES-0082", "LES-0082", "/book/architecture/architecture-system-design-foundations", "10-architecture-leadership", 1],
      ["LES-0083", "LES-0083", "/book/architecture/architecture-strategy-migration-governance", "10-architecture-leadership", 2],
      ["LES-0085", "LES-0085", "/book/architecture/technical-leadership-engineering-organizations", "10-architecture-leadership", 3],
      ["LES-0086", "LES-0086", "/book/architecture/behavioral-leadership-incident-project-interviews", "10-architecture-leadership", 4],
      ["LES-0087", "LES-0087", "/book/architecture/devops-sre-platform-career-roadmaps", "10-architecture-leadership", 5],
      ["LES-0088", "LES-0088", "/book/capstones/production-service-reliability-capstone", "11-capstones", 1],
      ["LES-0089", "LES-0089", "/book/capstones/kubernetes-platform-engineering-capstone", "11-capstones", 2],
      ["LES-0090", "LES-0090", "/book/capstones/distributed-data-reliability-capstone", "11-capstones", 3],
      ["LES-0091", "LES-0091", "/book/capstones/private-cloud-reliability-capstone", "11-capstones", 4],
      ["LES-0092", "LES-0092", "/book/capstones/secured-ai-incident-assistant", "11-capstones", 5],
    ],
  );
  for (const field of ["canonicalId", "stateId", "slug", "route"]) {
    const values = catalog.map((entry) => String(entry[field]));
    assert.equal(new Set(values).size, 92, `${field} must be unique`);
  }
  assert.equal(new Set(catalog.map((entry) => entry.volumeId)).size, 12);
  ...
  assert.equal(new Set(positions).size, 92, "volume-local positions must be unique");
  assert.equal(new Set(catalog.map((entry) => entry.order)).size, 20,
  ...
  assert.equal(catalog.find((entry) => entry.canonicalId === "LES-0008").availability,
    "substantive-draft");
  const lesson0001 = structuredMetadata.find(({ id }) => id === "LES-0001");
  const lesson0007 = structuredMetadata.find(({ id }) => id === "LES-0007");
  assert.throws(
    () => createReaderCatalog(legacyEntries, [lesson0001, {
      ...lesson0007,
      route: "/book/linux/storage",
    }]),
    /duplicate route/,
  ...
  assert.equal(startEnd.next?.canonicalId, "LES-0084");
  const startWritingEnd = adjacentReaderEntriesInCatalog(catalog, "technical-writing-operational-documents");
  assert.equal(startWritingEnd.previous?.canonicalId, "LES-0008");
  assert.equal(startWritingEnd.next, undefined);
  ...
  assert.equal(linuxEnd.next?.canonicalId, "LES-0073");
  const linuxPerformanceEnd = adjacentReaderEntriesInCatalog(catalog, "linux-performance-analysis-safe-tuning");
  assert.equal(linuxPerformanceEnd.previous?.canonicalId, "LES-0011");
  assert.equal(linuxPerformanceEnd.next, undefined);
  ...
  assert.equal(engineeringCiPlatforms.next?.canonicalId, "LES-0049");
  const engineeringGitOps = adjacentReaderEntriesInCatalog(
    catalog,
    "gitops-reconciliation-promotion",
  );
  assert.equal(engineeringGitOps.previous?.canonicalId, "LES-0025");
  assert.equal(engineeringGitOps.next, undefined);
  ...
  assert.equal(reliabilityStart.next?.canonicalId, "LES-0027");
  const reliabilityTelemetry = adjacentReaderEntriesInCatalog(
    catalog,
    "opentelemetry-instrumentation-pipelines",
  );
  assert.equal(reliabilityTelemetry.previous?.canonicalId, "LES-0026");
  assert.equal(reliabilityTelemetry.next?.canonicalId, "LES-0028");
  const reliabilityEnd = adjacentReaderEntriesInCatalog(
    catalog,
  ...
  assert.equal(resilienceEnd.next?.canonicalId, "LES-0074");
  const infrastructureCloud = adjacentReaderEntriesInCatalog(
    catalog,
    "cloud-architecture-provider-neutral-foundations",
  );
  assert.equal(infrastructureCloud.previous?.canonicalId, "LES-0048");
  assert.equal(infrastructureCloud.next?.canonicalId, "LES-0051");
  const infrastructureEnd = adjacentReaderEntriesInCatalog(catalog, "gcp-foundations-reliability");
  assert.equal(infrastructureEnd.previous?.canonicalId, "LES-0054");
  assert.equal(infrastructureEnd.next?.canonicalId, "LES-0081");
  const stateStart = adjacentReaderEntriesInCatalog(catalog, "sql-postgresql-internals-reliability");
  assert.equal(stateStart.previous, undefined);
  assert.equal(stateStart.next?.canonicalId, "LES-0057");
  const stateEnd = adjacentReaderEntriesInCatalog(catalog, "distributed-workflows-reliability");
  assert.equal(stateEnd.previous?.canonicalId, "LES-0060");
  assert.equal(stateEnd.next?.canonicalId, "LES-0062");
  const stateVolumeEnd = adjacentReaderEntriesInCatalog(catalog, "specialized-data-service-reliability");
  assert.equal(stateVolumeEnd.previous?.canonicalId, "LES-0064");
  ...
  assert.equal(securityEnd.next?.canonicalId, "LES-0072");
  const architectureStart = adjacentReaderEntriesInCatalog(catalog, "architecture-system-design-foundations");
  assert.equal(architectureStart.previous, undefined);
  assert.equal(architectureStart.next?.canonicalId, "LES-0083");
  const architectureEnd = adjacentReaderEntriesInCatalog(catalog, "behavioral-leadership-incident-project-interviews");
  assert.equal(architectureEnd.previous?.canonicalId, "LES-0085");
  assert.equal(architectureEnd.next?.canonicalId, "LES-0087");
  const roadmapEnd = adjacentReaderEntriesInCatalog(catalog, "devops-sre-platform-career-roadmaps");
  assert.equal(roadmapEnd.previous?.canonicalId, "LES-0086");
  assert.equal(roadmapEnd.next, undefined);
  const capstoneStart = adjacentReaderEntriesInCatalog(catalog, "production-service-reliability-capstone");
  assert.equal(capstoneStart.previous, undefined);
  assert.equal(capstoneStart.next?.canonicalId, "LES-0089");
  const capstoneEnd = adjacentReaderEntriesInCatalog(catalog, "secured-ai-incident-assistant");
  assert.equal(capstoneEnd.previous?.canonicalId, "LES-0091");
  assert.equal(capstoneEnd.next, undefined);
});
...
test("an eight-entry v1 reading state gains canonical and extended lessons without prior state loss", () => {
  ...
  assert.equal(loaded.recoveredInvalidData, false);
  const newCanonicalIds = Array.from({ length: 84 }, (_, index) =>
...
test("the live production search set has ninety-two unique lessons and stable golden rankings", () => {
  ...
  assert.equal(new Set(documents.map((document) => document.id)).size, 92);
  assert.equal(new Set(documents.map((document) => document.href)).size, 92);
  ...
  assert.equal(documents.find((document) => document.id === "LES-0027")?.volumeNumber, "04");
  assert.equal(documents.find((document) => document.id === "LES-0027")?.volumeTitle, "Reliability and operations");
  ...
  const goldenQueries = new Map([
    ...
    ["V04-L02", "LES-0027"],
    ["OBS-002", "LES-0027"],
    ["opentelemetry pipeline", "LES-0027"],
    ["PromQL", "LES-0028"],
    ...
    ["infrastructure as code foundations", "LES-0037"],
    ["terraform opentofu language plan", "LES-0038"],
    ["modules state recovery", "LES-0039"],
    ["ansible configuration management", "LES-0040"],
    ["kubernetes control plane reconciliation", "LES-0041"],
    ["workloads scheduling rollouts", "LES-0042"],
    ["services dns network policy", "LES-0043"],
    ["storage persistence recovery", "LES-0044"],
    ["rbac admission tenancy", "LES-0045"],
    ["helm kustomize packaging releases", "LES-0046"],
    ["operators custom resources admission", "LES-0047"],
    ["kubernetes production operations", "LES-0048"],
    ["gitops reconciliation promotion", "LES-0049"],
    ["cloud architecture provider neutral", "LES-0050"],
    ["identity secrets certificates zero trust", "LES-0051"],
    ["cloud networking hybrid connectivity", "LES-0052"],
    ["aws foundations reliability", "LES-0053"],
    ["azure foundations reliability", "LES-0054"],
    ["gcp foundations reliability", "LES-0055"],
    ["postgresql internals reliability", "LES-0056"],
    ["api event contracts reliability", "LES-0057"],
    ["distributed systems foundations", "LES-0058"],
    ["nosql cache reliability", "LES-0059"],
    ["queues streams reliability", "LES-0060"],
    ["distributed workflows reliability", "LES-0061"],
    ["data pipeline reliability", "LES-0062"],
    ["lakehouse table reliability", "LES-0063"],
...
test("every staged draft preview has parseable lesson, assessment, and reference support", () => {
  ...
  const lessonFiles = readdirSync(draftsDirectory, { withFileTypes: true })
    ...
    .sort();
  assert.equal(lessonFiles.length, 0);
  ...
  assert.equal(extendedVolumes.length, 0);
  assert.equal(extendedVolumes.reduce((total, volume) => total + volume.drafts.length, 0), 0);
});
...
test("staged draft parsing preserves exact declared reference order", () => {
  const slug = "LES-0087-devops-sre-platform-career-roadmaps";
  const lessonPath = join(repositoryRoot, "book", "volumes", "10-architecture-leadership", slug, "lesson.md");
  const source = readFileSync(lessonPath, "utf8");
  const lesson = parseStructuredLesson(source);
  const assessments = lesson.metadata.assessmentIds.map((id) =>
    JSON.parse(readFileSync(join(repositoryRoot, "book", "assessments", "career-development", `${id}.json`), "utf8")));
  const references = lesson.metadata.referenceIds.map((id) =>
    JSON.parse(readFileSync(join(repositoryRoot, "book", "references", `${id}.json`), "utf8")));
...
test("staged draft previews are locally searchable without joining the canonical registry", () => {
  const raw = readFileSync(join(repositoryRoot, "book", "volumes", "10-architecture-leadership", "LES-0087-devops-sre-platform-career-roadmaps", "lesson.md"), "utf8");
  const documents = createStagedDraftSearchDocuments([{
    slug: "LES-0087-devops-sre-platform-career-roadmaps",
    lesson: parseStructuredLesson(raw),
  }]);
  assert.equal(documents[0].href, "/drafts/LES-0087-devops-sre-platform-career-roadmaps");
  assert.equal(documents[0].id, "draft-LES-0087");
  assert.equal(searchLessons(documents, "devops sre platform career roadmaps")[0]?.document.id, "draft-LES-0087");
});
...
test("all ninety-two independent transfers stay answer-isolated from their answered records", () => {
