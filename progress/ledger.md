...
|---|---|---|
| [Local learning cockpit](../learning-cockpit/README.md) | Canonical feature `f2e3e23` exposes twenty-six routed lesson identities across Volumes 00 through 04: five legacy and twenty-one structured; artifact publication is not learner competency evidence | The generated corpus validates at 21 lessons, 63 assessments, and 172 references; automated integration and exact remote parity pass, while real-browser interaction remains unclaimed |
...
| [LES-0026 — Observability foundations](../book/volumes/04-reliability-operations/LES-0026-observability-foundations/lesson.md) | Schema-backed `substantive-draft` in canonical feature `f2e3e23` as `LES-0026` / alias `V04-L01` / `OBS-001` at `/book/reliability/observability-foundations`, with three assessments, nine official or primary references, and a bounded local five-signal lab; artifact publication and mentor execution are not learner competency evidence | Canonical content, registry, schema, reader, lint, typecheck, build, Ubuntu verifier, HTTP, asset, link, hygiene, feature commit, push, and parity gates pass; real-browser interaction is unavailable. The fixture proves only its encoded local model; it is not a representative instrumented service, OpenTelemetry SDK or Collector, Prometheus, Grafana, continuous profiler, vendor backend, production behavior, causality proof, learner transfer, formal acceptance, delayed recall, or mastery |
